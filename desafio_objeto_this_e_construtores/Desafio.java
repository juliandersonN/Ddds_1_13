...
/*
Você é um empresário da área de tecnologia da informação que tem um bom faturamento mensal, porém suas contas a pagar estão totalmente desorganizadas.
A planilha Excel que você usa já não suporta mais o movimento que a empresa possui, e chegou a hora de investir no desenvolvimento de um sistema financeiro para a empresa.
...
sendo um construtor padrão (sem parâmetros), que não deve fazer nada, e outro construtor que recebe alguns parâmetros e deve atribuir os valores recebidos às variáveis de instância.
